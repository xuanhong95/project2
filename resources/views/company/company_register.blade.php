                ...
                <div class="col-md-10 col-md-offset-1" style="margin-top: 15px">
                    ...
                    <table class="col-md-12"  style="border:1px solid black;">
                        <tr>
                            ...
                            <td class="col-md-3" colspan="3">{!! $form->field('name') !!}
                            </td>
                        </tr>
                        <tr>
                            <td class="col-md-3 name_field"> Địa chỉ
                            </td>
                            <td class="col-md-3" colspan="3">{!! $form->field('address') !!}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="col-md-3">{!! $form->field('email') !!}</td>
                        </tr>
                    </table>
                </div>

                <div class="col-md-10 col-md-offset-1" style="margin-top: 15px">
                    <strong>2. Số lượng sinh viên có thể tiếp nhận: </strong>
                </div>
